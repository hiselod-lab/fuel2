...
def generate_detailed_forecast(res, group_eng, product, forecast_weeks, forecast_method,
    ...
    if forecast_method == 'Direct':
        ...
        for i in range(forecast_weeks):
            ...
            temp_history = pd.concat([forecast_history, pd.DataFrame([future_data])], ignore_index=True)
        ...
        for i in range(forecast_weeks):
            ...
            forecast_history = pd.concat([forecast_history, pd.DataFrame([current_data])], ignore_index=True)
